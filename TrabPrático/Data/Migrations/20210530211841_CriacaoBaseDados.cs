        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "17+", new DateTime(2015, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "The Witcher 3: Wild Hunt é um jogo eletrónico de ação do subgénero RPG desenvolvido pela CD Projekt RED e lançado no dia 19 de maio de 2015 para as plataformas Microsoft Windows, PlayStation 4, Xbox One e em outubro de 2019 para a Nintendo Switch, sendo o terceiro título da série de jogos The Witcher.Ele sucede The Witcher e The Witcher 2: Assassins of Kings(2011), que foram baseados na série de livros de fantasia Wiedźmin, do escritor polonês Andrzej Sapkowski.", "TW3_Wild_Hunt.png", 0.0, "The Witcher 3: Wild Hunt", 93.0, "Ação, RPG" },
                    ...
                    { 8, "3+", new DateTime(2019, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Need for Speed Heat é um jogo eletrónico de corrida desenvolvido pela Ghost Games e publicado pela Electronic Arts para Microsoft Windows, PlayStation 4 e Xbox One. Este é o vigésimo quarto jogo de série Need for Speed e comemora o aniversário de 25 anos da série.", "NeedForSpeed.png", 0.0, "Need for Speed Heat", 72.0, "Corrida, Mundo Aberto" },
                    ...
                    { 10, "17+", new DateTime(2018, 3, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Far Cry 5 é um jogo eletrónico de tiro em primeira pessoa de ação-aventura ambientado num mundo aberto.  Foi desenvolvido pela Ubisoft Montreal e publicado pela Ubisoft para Microsoft Windows, PlayStation 4 e Xbox One a 27 de março de 2018 e foi lançado a 3 de Novembro para o Google Stadia, junto com o Far Cry: New Dawn. É o décimo titulo da serie Far Cry e o quinto jogo principal.", "FarCry3.jpg", 0.0, "FarCry 5", 78.0, "Ação, Aventura, First Person Shooter" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "steamlogo.png", 1, "https://store.steampowered.com/app/1313860/EA_SPORTS_FIFA_21/", "Steam" },
                    { 2, "steamlogo.png", 2, "https://store.steampowered.com/app/1091500/Cyberpunk_2077/", "Steam" },
                    { 3, "steamlogo.png", 3, "https://store.steampowered.com/app/292030/The_Witcher_3_Wild_Hunt/", "Steam" },
                    { 4, "steamlogo.png", 4, "https://store.steampowered.com/app/582160/Assassins_Creed_Origins/", "Steam" },
                    { 5, "steamlogo.png", 5, "https://store.steampowered.com/app/271590/Grand_Theft_Auto_V/", "Steam" },
                    { 6, "steamlogo.png", 6, "https://store.steampowered.com/app/1263850/Football_Manager_2021/", "Steam" },
                    { 7, "steamlogo.png", 7, "https://store.steampowered.com/app/374320/DARK_SOULS_III/", "Steam" },
                    { 8, "steamlogo.png", 8, "https://store.steampowered.com/app/1222680/Need_for_Speed_Heat/", "Steam" },
                    { 9, "steamlogo.png", 9, "https://store.steampowered.com/app/1057090/Ori_and_the_Will_of_the_Wisps/", "Steam" },
                    { 10, "steamlogo.png", 10, "https://store.steampowered.com/app/552520/Far_Cry_5/", "Steam" }
                });
